...
if(!_.isUndefined(window._satellite)){var n=m==="LIKE"?"communities-scf-vote-up":"communities-scf-vote-down";
window._satellite.track(n)
}else{if(a.Sitecatalyst){var n=m==="LIKE"?"SCFVoteUp":"SCFVoteDown";
...
e.response=i;
e.tallyType="Voting";
e[":operation"]="social:postTallyResponse";
